...
EXPOSE 8080
RUN cp /opt/jenkins/workspace/module-8-mfilipovich-build/helloworld-project/helloworld-ws/target/helloworld-ws.war /opt/tomcat/webapps/helloworld-ws.war
